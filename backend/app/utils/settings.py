...
class Settings:
    ...
    API_LOG_TTL_DAYS = env_int("API_LOG_TTL_DAYS", 7)
    PASSWORD_RESET_OTP_EXPIRE_MINUTES = env_int("PASSWORD_RESET_OTP_EXPIRE_MINUTES", 10)
    PASSWORD_RESET_TOKEN_EXPIRE_MINUTES = env_int("PASSWORD_RESET_TOKEN_EXPIRE_MINUTES", 10)
