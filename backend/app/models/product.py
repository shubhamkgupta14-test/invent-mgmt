...
class ProductAttributes(SecureBaseModel):
...
class ProductBase(SecureBaseModel):
    ...
    supplier_id: str = Field(
        ..., min_length=1, max_length=50, description="ID of the supplier providing this product")
...
class ProductUpdate(SecureBaseModel):
...
class ProductDeleteRequest(SecureBaseModel):
    sku: str = Field(..., min_length=2, max_length=50,
                     description="Unique product SKU code")
